...
class arp_proxy():
    ...
    def parse_eth_frame(self, frame):
        ...
        eth_frame = {"dst_mac": ':'.join('%02x' % b for b in eth_detailed[0]),
                     "src_mac": ':'.join('%02x' % b for b in eth_detailed[1]),
                     "type": eth_detailed[2]}
    ...
    def parse_arp_packet(self, packet):
        ...
        arp_packet = {"htype": arp_detailed[0],
                      ...
                      "plen": arp_detailed[3],
                      "oper": arp_detailed[4],
                      "src_mac": ':'.join('%02x' % b for b in arp_detailed[5]),
                      "src_ip": socket.inet_ntoa(arp_detailed[6]),
                      "dst_mac": ':'.join('%02x' % b for b in arp_detailed[7]),
    ...
    def send_gratuitous_arp(self, changes):
        ...
        self.raw_socket.send(b''.join(eth_frame))   
